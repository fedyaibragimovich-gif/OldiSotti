...
import { ShieldCheck, ArrowLeftRight, HelpCircle, Megaphone, Send, ChevronRight } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl px-3 sm:px-4 py-4 sm:py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center justify-center gap-1.5 flex-wrap">
            <button id="footer-help-btn" type="button" onClick={() => onOpenInfoModal?.('help')} className="inline-flex items-center gap-1.5 rounded-lg bg-white/5 border border-white/10 px-2.5 py-1.5 text-[10px] font-semibold text-slate-200 hover:bg-white/10 hover:text-white transition-colors cursor-pointer">
              <HelpCircle size={13} />
